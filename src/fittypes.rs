...
impl From<u8> for FitFieldPowerPhaseType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldPowerPhaseType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLeftRightBalance {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLeftRightBalance", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldWorkoutCapabilities {
    fn from(code: u32) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWorkoutCapabilities", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSensorType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSensorType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldGender {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldGender", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSessionTrigger {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSessionTrigger", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldFileFlags {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldFileFlags", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldMesgCount {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldMesgCount", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldFitBaseType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldFitBaseType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldTimerTrigger {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldTimerTrigger", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportEvent {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportEvent", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldAutoscroll {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAutoscroll", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldStrokeType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldStrokeType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldWeatherSevereType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWeatherSevereType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldHrZoneCalc {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldHrZoneCalc", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldHrType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldHrType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSegmentLeaderboardType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSegmentLeaderboardType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldAttitudeStage {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAttitudeStage", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDigitalWatchfaceLayout {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDigitalWatchfaceLayout", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldPwrZoneCalc {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldPwrZoneCalc", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldWktStepTarget {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWktStepTarget", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldActivity {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldActivity", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldWatchfaceMode {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWatchfaceMode", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldCoursePoint {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldCoursePoint", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSide {
    fn from(code: u8) -> Self {
        match code {
            ...
            1 => FitFieldSide::Left,
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSide", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldAnalogWatchfaceLayout {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAnalogWatchfaceLayout", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldWeight {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWeight", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldIntensity {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldIntensity", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldConnectivityCapabilities {
    fn from(code: u32) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldConnectivityCapabilities", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSport {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSport", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldEvent {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldEvent", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDisplayPower {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDisplayPower", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldBikeLightNetworkConfigType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldBikeLightNetworkConfigType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldBpStatus {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldBpStatus", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldBikeLightBeamAngleMode {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldBikeLightBeamAngleMode", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldLocaltimeIntoDay {
    fn from(code: u32) -> Self {
        match code {
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLocaltimeIntoDay", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDisplayPosition {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDisplayPosition", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldGoalRecurrence {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldGoalRecurrence", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSchedule {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSchedule", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldLeftRightBalance100 {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLeftRightBalance100", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldCommTimeoutType {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldCommTimeoutType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSegmentLapStatus {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSegmentLapStatus", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldManufacturer {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldManufacturer", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLengthType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLengthType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLanguage {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLanguage", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldActivityClass {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldActivityClass", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldAttitudeValidity {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAttitudeValidity", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldTimeZone {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldTimeZone", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSegmentSelectionType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSegmentSelectionType", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldUserLocalId {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldUserLocalId", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldExdDescriptors {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldExdDescriptors", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldActivityType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldActivityType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldAutolapTrigger {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAutolapTrigger", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldBacklightMode {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldBacklightMode", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDisplayOrientation {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDisplayOrientation", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLapTrigger {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLapTrigger", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldCourseCapabilities {
    fn from(code: u32) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldCourseCapabilities", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldTimeMode {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldTimeMode", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldExdQualifiers {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldExdQualifiers", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldGoalSource {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldGoalSource", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDateMode {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDateMode", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSubSport {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSubSport", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDeviceIndex {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDeviceIndex", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportBits0 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportBits0", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportBits1 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportBits1", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportBits2 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportBits2", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportBits3 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportBits3", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportBits4 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportBits4", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportBits5 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportBits5", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSportBits6 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSportBits6", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSegmentDeleteStatus {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSegmentDeleteStatus", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldFitnessEquipmentState {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldFitnessEquipmentState", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldAutoActivityDetect {
    fn from(code: u32) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAutoActivityDetect", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldRiderPositionType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldRiderPositionType", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldGarminProduct {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldGarminProduct", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldExdLayout {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldExdLayout", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldWorkoutPower {
    fn from(code: u32) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWorkoutPower", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldWeatherReport {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWeatherReport", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldActivitySubtype {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldActivitySubtype", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDayOfWeek {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDayOfWeek", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldAntplusDeviceType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAntplusDeviceType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldTurnType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldTurnType", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldFitBaseUnit {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldFitBaseUnit", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldBatteryStatus {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldBatteryStatus", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldChecksum {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldChecksum", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldWorkoutHr {
    fn from(code: u32) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWorkoutHr", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLanguageBits3 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLanguageBits3", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLanguageBits2 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLanguageBits2", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLanguageBits1 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLanguageBits1", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLanguageBits0 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLanguageBits0", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldEventType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldEventType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldLanguageBits4 {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldLanguageBits4", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldBodyLocation {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldBodyLocation", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldFile {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldFile", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDisplayMeasure {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDisplayMeasure", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldCameraEventType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldCameraEventType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldAutoSyncFrequency {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAutoSyncFrequency", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldMessageIndex {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldMessageIndex", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldGoal {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldGoal", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldActivityLevel {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldActivityLevel", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldWktStepDuration {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWktStepDuration", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldWeatherSeverity {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWeatherSeverity", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldCameraOrientationType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldCameraOrientationType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldWeatherStatus {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldWeatherStatus", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldExdDisplayType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldExdDisplayType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSourceType {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSourceType", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldDisplayHeart {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldDisplayHeart", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldTimeIntoDay {
    fn from(code: u32) -> Self {
        match code {
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldTimeIntoDay", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSwimStroke {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSwimStroke", invalid_field_num))
        }
    }
}
...
impl From<u32> for FitFieldSupportedExdScreenLayouts {
    fn from(code: u32) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSupportedExdScreenLayouts", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldSwitch {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldSwitch", invalid_field_num))
        }
    }
}
...
impl From<u16> for FitFieldMesgNum {
    fn from(code: u16) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldMesgNum", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldAntNetwork {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldAntNetwork", invalid_field_num))
        }
    }
}
...
impl From<u8> for FitFieldExdDataUnits {
    fn from(code: u8) -> Self {
        match code {
            ...
            invalid_field_num => panic!(format!("invalid field num {} for FitFieldExdDataUnits", invalid_field_num))
        }
    }
}
